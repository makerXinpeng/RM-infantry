...
/******************************************************************************************
//
//! \brief  Get an element from FIFO(in single mode).从FIFO获取一个元素(在单模态)
//!
//! \param  [in]  pfifo is the pointer of valid FIFO.pfifo是有效FIFO的指针
//!
//! \retval the data element of FIFO.FIFO的数据元素
//
******************************************************************************************/
